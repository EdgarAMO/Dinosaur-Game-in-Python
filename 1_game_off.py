...
"""
This game draws the background, the moving floor and the pipes on the screen.
Mario can jump by tapping the space bar or by pressing it for a longer time,
and there is no collision yet.
"""
