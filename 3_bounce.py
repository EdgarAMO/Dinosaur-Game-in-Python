...
"""
This version includes the bouncing option when you hold down the space
bar just before jumping. This is useful when coming across multiple rows
of pipes, this way you don't have to tap the space bar continuously.
"""
